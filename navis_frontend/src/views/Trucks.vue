            ...
            <div class="hidden lg:flex font-base mt-5 justify-between">
                <div class="flex gap-4 items-center">
                    ...
                    <div class="relative ml-5">
                        <input v-model="text" class="pl-8 w-72 bg-white py-2 rounded-md focus:outline-none font-base text-sm placeholder:text-xs" type="text" placeholder="Search trucks by chassis or reg no">
